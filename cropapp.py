...
import bz2
import pandas as pd
st.set_page_config(page_title="Crop Recommendation", font-color="#ffffff", page_icon="fevicon.png", layout="centered", initial_sidebar_state="auto", menu_items=None)
def set_bg_hack_url():
    '''
